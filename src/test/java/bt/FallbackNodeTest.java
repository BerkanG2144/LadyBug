...
public class FallbackNodeTest {
    ...
    void first_success_short_circuits_to_success() {
        ...
        fb.addChildren(new LeafNode("c1", b1, LeafNode.LeafKind.CONDITION)); // should run and stop
        fb.addChildren(new LeafNode("a1", b2, LeafNode.LeafKind.ACTION));    // should NOT run
    ...
    void all_fail_results_in_failure() {
        ...
        fb.addChildren(new LeafNode("c1", b1, LeafNode.LeafKind.CONDITION));
        fb.addChildren(new LeafNode("a1", b2, LeafNode.LeafKind.ACTION));
